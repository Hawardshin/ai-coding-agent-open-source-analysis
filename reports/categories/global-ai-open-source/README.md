...
- 조사 단위: `global-ai-open-source` artifact 카테고리에 속한 오픈소스, 논문, 발표/트렌드, 참고자료 묶음입니다.
- 포함 범위: 519 entries이며, 주요 구성은 repository (519)입니다.
- 연결 보고서: [global-trending-open-source](../../by-topic/global-trending-open-source/README.md).
...
- Total categorized entries: 519
- Repositories: 519
- Research papers: 0
- Presentations/conferences/trend references: 0
- Reference materials: 0
- Data file: [data/categories/global-ai-open-source.json](../../../data/categories/global-ai-open-source.json)
- Related report topics: [global-trending-open-source](../../by-topic/global-trending-open-source/README.md)
...
Complete category membership is stored in [data/categories/global-ai-open-source.json](../../../data/categories/global-ai-open-source.json).
