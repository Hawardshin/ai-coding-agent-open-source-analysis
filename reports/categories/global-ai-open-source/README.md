...
- 포함 범위: 519개 항목이며, 주요 구성은 repository (519)입니다.
...
- 발표/컨퍼런스/트렌드 자료: 0
- 참고자료: 0
- 데이터 파일: [data/categories/global-ai-open-source.json](../../../data/categories/global-ai-open-source.json)
- 연결된 보고서 주제: [global-trending-open-source](../../by-topic/global-trending-open-source/README.md)
...
전체 카테고리 멤버십은 [data/categories/global-ai-open-source.json](../../../data/categories/global-ai-open-source.json)에 저장됩니다.
