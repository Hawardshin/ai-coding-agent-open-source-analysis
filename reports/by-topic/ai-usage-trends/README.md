...
- 조사 단위: `ai-usage-trends` 주제에 속한 보고서 묶음입니다.
- 포함 범위: 3 reports이며, 주요 보고서 유형은 presentation-report (2), category-guide (1)입니다.
- 주요 출처 폴더: presentations (2), categories (1).
...
- Reports: 3
- Data: [data/report-categories/ai-usage-trends.json](../../../data/report-categories/ai-usage-trends.json)
