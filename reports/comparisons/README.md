...
프로젝트 간 taxonomy, 기능 비교, 유사도 cluster를 정리한 보고서입니다.

## 요약

- 조사 단위: `reports/comparisons` 물리 폴더에 모인 보고서 묶음입니다.
- 포함 범위: 2개 보고서이며, 주요 유형은 comparison-report (2)입니다.
...
| 항목 | 값 |
| --- | --- |
| 폴더 | `reports/comparisons` |
| 역할 | 프로젝트 간 비교와 관계 지도. |
| 보고서 수 | 2 |
| 주요 보고서 유형 | comparison-report (2) |
