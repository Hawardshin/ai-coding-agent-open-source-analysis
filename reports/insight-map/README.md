...
| 핵심 | 바로 볼 곳 | 판단 |
| --- | --- | --- |
| 주제의 의미 | [이 문서](README.md) | “왜 이 주제를 봐야 하는가”를 먼저 잡습니다. |
| 구현 차이 | [상세 비교 리포트](../source-insights/comparative-report.md) | 카테고리별 강점, 약점, 대표 레포를 비교합니다. |
| 실제 코드 근거 | [소스 딥다이브](../source-deep-dives/README.md) | README 설명이 아니라 파일 경로로 확인합니다. |
| 전체 자료 목록 | [표/CSV 목차](../tables/README.md) | 많은 항목은 표로 필터링합니다. |
...
| 주제 | 수 | 핵심 질문 | 먼저 뽑을 것 | 위치 |
| --- | ---: | --- | --- | --- |
| [레포별 딥다이브](../by-topic/repository-deep-dives/README.md) | 2434 | 특정 레포 하나를 깊게 볼 때 어떤 요약과 근거가 있는가? | 레포별 총평 | [읽기](../by-topic/repository-deep-dives/README.md) / [데이터](../../data/report-categories/repository-deep-dives.json) |
| [비교/유사도 지도](../by-topic/comparisons/README.md) | 1195 | 비슷해 보이는 프로젝트들은 무엇이 다르고 어느 카테고리에 속하는가? | 기능별 비교 | [읽기](../by-topic/comparisons/README.md) / [데이터](../../data/report-categories/comparisons.json) |
| [소스 코드 딥다이브](../by-topic/source-code-deep-dives/README.md) | 1187 | README 설명이 아니라 실제 코드에서 어떤 구조가 확인되는가? | 핵심 파일 경로 | [읽기](../by-topic/source-code-deep-dives/README.md) / [데이터](../../data/report-categories/source-code-deep-dives.json) |
| [글로벌 트렌딩 오픈소스](../by-topic/global-trending-open-source/README.md) | 502 | 글로벌에서 star velocity와 커뮤니티 신호가 강한 프로젝트는 무엇인가? | 글로벌 인기 프로젝트 | [읽기](../by-topic/global-trending-open-source/README.md) / [데이터](../../data/report-categories/global-trending-open-source.json) |
| [한국 트렌딩 오픈소스](../by-topic/korea-trending-open-source/README.md) | 502 | 한국에서 실제 관심을 받고 있는 소스와 구현 주제는 무엇인가? | 국내 트렌드 레포 | [읽기](../by-topic/korea-trending-open-source/README.md) / [데이터](../../data/report-categories/korea-trending-open-source.json) |
| [LLM 위키/RAG/지식베이스](../by-topic/llm-wiki/README.md) | 292 | 코드와 문서를 어떻게 수집하고 검색하고 출처와 함께 기억할 것인가? | ingestion/chunking pipeline | [읽기](../by-topic/llm-wiki/README.md) / [데이터](../../data/report-categories/llm-wiki.json) |
| [에이전트 하네스/MCP/오케스트레이션](../by-topic/agent-harness/README.md) | 281 | LLM이 도구와 워크플로를 안전하게 실행하려면 어떤 하네스가 필요한가? | MCP/tool 연결 | [읽기](../by-topic/agent-harness/README.md) / [데이터](../../data/report-categories/agent-harness.json) |
| [클론 구조/인벤토리](../by-topic/clone-structure-inventory/README.md) | 128 | 분석 대상 소스는 실제로 어디에 있고 어떤 구조를 갖는가? | 로컬 소스 위치 | [읽기](../by-topic/clone-structure-inventory/README.md) / [데이터](../../data/report-categories/clone-structure-inventory.json) |
| [코딩 에이전트/IDE](../by-topic/coding-agents/README.md) | 124 | 코딩 에이전트 제품은 어떤 실행 루프와 코드 수정 표면을 가져야 하는가? | CLI/IDE 실행면 | [읽기](../by-topic/coding-agents/README.md) / [데이터](../../data/report-categories/coding-agents.json) |
| [스펙 드리븐/요구사항](../by-topic/spec-driven/README.md) | 42 | 스펙을 어떻게 뽑고 저장하고 테스트 trace와 연결해야 오래 기억되는가? | 스펙 추출 방식 | [읽기](../by-topic/spec-driven/README.md) / [데이터](../../data/report-categories/spec-driven.json) |
| [먼저 읽기](../by-topic/start-here/README.md) | 21 | 이 레포에서 먼저 무엇을 읽어야 하는가? | 전체 조사 구조 | [읽기](../by-topic/start-here/README.md) / [데이터](../../data/report-categories/start-here.json) |
| [인접 AI 인프라](../by-topic/adjacent-infrastructure/README.md) | 18 | 에이전트를 제품화하려면 주변 인프라에서 무엇을 갖춰야 하는가? | 컨텍스트/메모리 계층 | [읽기](../by-topic/adjacent-infrastructure/README.md) / [데이터](../../data/report-categories/adjacent-infrastructure.json) |
| [카테고리별 근거](../by-topic/category-guides/README.md) | 18 | 각 근거는 어떤 종류이고 어떤 조사 질문을 뒷받침하는가? | 근거 유형별 분포 | [읽기](../by-topic/category-guides/README.md) / [데이터](../../data/report-categories/category-guides.json) |
| [발표/컨퍼런스](../by-topic/presentations-conferences/README.md) | 9 | 최근 발표들이 AI 활용과 에이전트 설계에서 무엇을 강조하는가? | 빅테크 발표 흐름 | [읽기](../by-topic/presentations-conferences/README.md) / [데이터](../../data/report-categories/presentations-conferences.json) |
| [연구 근거](../by-topic/research-foundations/README.md) | 7 | 코드와 트렌드를 설명하는 연구적 근거는 무엇인가? | 핵심 논문과 이론 | [읽기](../by-topic/research-foundations/README.md) / [데이터](../../data/report-categories/research-foundations.json) |
| [소스 카탈로그/인벤토리](../by-topic/source-catalogs-and-inventories/README.md) | 6 | 자료 목록과 출처를 빠짐없이 추적하려면 어디를 봐야 하는가? | 전체 자료 목록 | [읽기](../by-topic/source-catalogs-and-inventories/README.md) / [데이터](../../data/report-categories/source-catalogs-and-inventories.json) |
| [AI 활용 트렌드](../by-topic/ai-usage-trends/README.md) | 3 | 최근 6~12개월 AI 활용은 어떤 업무와 아키텍처로 이동하고 있는가? | agentic enterprise 흐름 | [읽기](../by-topic/ai-usage-trends/README.md) / [데이터](../../data/report-categories/ai-usage-trends.json) |
| [전체 소스 스캔/코드 검색](../by-topic/full-source-scan/README.md) | 3 | 코딩 에이전트는 어떤 파일을 찾아 읽고, 왜 그 파일이 답이라고 판단하는가? | 파일 발견과 랭킹 축 | [읽기](../by-topic/full-source-scan/README.md) / [데이터](../../data/report-categories/full-source-scan.json) |


## 소스 인사이트 핵심 지도

| 카테고리 | 레포 | 핵심 강점 | 먼저 확인할 것 | 대표 레포 | 위치 |
| --- | ---: | --- | --- | --- | --- |
| [에이전트 하네스/MCP](../source-insights/by-category/agent-harness-mcp/README.md) | 514 | test/eval coverage 90%; MCP/tool 경로 76%; retrieval/memory 경로 84% | 큰 구조적 공백은 표면상 작지만, 대표 레포별 위험 신호를 확인해야 함 | [mem0ai/mem0](https://github.com/mem0ai/mem0) | [읽기](../source-insights/by-category/agent-harness-mcp/README.md) |
| [일반 AI 오픈소스](../source-insights/by-category/general-ai-open-source/README.md) | 268 | 트렌드 연결률 98%로 현재성 강함; test/eval coverage 76% | security/policy 경로 16%; CI 경로 40%; 중앙 소스 깊이 60로 직접 확인 필요 | [Aider-AI/aider](https://github.com/Aider-AI/aider) | [읽기](../source-insights/by-category/general-ai-open-source/README.md) |
| [LLM 위키/RAG/지식베이스](../source-insights/by-category/llm-wiki-rag/README.md) | 172 | test/eval coverage 86%; retrieval/memory 경로 83%; CLI 사용면이 강함 | 큰 구조적 공백은 표면상 작지만, 대표 레포별 위험 신호를 확인해야 함 | [MervinPraison/PraisonAI](https://github.com/MervinPraison/PraisonAI) | [읽기](../source-insights/by-category/llm-wiki-rag/README.md) |
| [AI 인프라/서빙](../source-insights/by-category/ai-infrastructure-serving/README.md) | 75 | 트렌드 연결률 92%로 현재성 강함; test/eval coverage 96%; retrieval/memory 경로 95% | 큰 구조적 공백은 표면상 작지만, 대표 레포별 위험 신호를 확인해야 함 | [Mintplex-Labs/anything-llm](https://github.com/Mintplex-Labs/anything-llm) | [읽기](../source-insights/by-category/ai-infrastructure-serving/README.md) |
| [개발 생산성/DevTools](../source-insights/by-category/developer-productivity/README.md) | 49 | 트렌드 연결률 98%로 현재성 강함; test/eval coverage 82%; retrieval/memory 경로 67% | 큰 구조적 공백은 표면상 작지만, 대표 레포별 위험 신호를 확인해야 함 | [nilbuild/developer-roadmap](https://github.com/nilbuild/developer-roadmap) | [읽기](../source-insights/by-category/developer-productivity/README.md) |
| [평가/관측/품질](../source-insights/by-category/eval-observability/README.md) | 27 | test/eval coverage 100%; retrieval/memory 경로 74% | 큰 구조적 공백은 표면상 작지만, 대표 레포별 위험 신호를 확인해야 함 | [mock-server/mockserver-monorepo](https://github.com/mock-server/mockserver-monorepo) | [읽기](../source-insights/by-category/eval-observability/README.md) |
| [보안/거버넌스/안전](../source-insights/by-category/security-governance/README.md) | 10 | 트렌드 연결률 90%로 현재성 강함; test/eval coverage 90% | 중앙 소스 깊이 75로 직접 확인 필요 | [perplexityai/bumblebee](https://github.com/perplexityai/bumblebee) | [읽기](../source-insights/by-category/security-governance/README.md) |
| [코딩 에이전트/IDE](../source-insights/by-category/coding-agent-ide/README.md) | 9 | 트렌드 연결률 100%로 현재성 강함; test/eval coverage 100%; MCP/tool 경로 67% | 큰 구조적 공백은 표면상 작지만, 대표 레포별 위험 신호를 확인해야 함 | [gastownhall/beads](https://github.com/gastownhall/beads) | [읽기](../source-insights/by-category/coding-agent-ide/README.md) |
| [데이터/벡터 플랫폼](../source-insights/by-category/data-vector-platform/README.md) | 7 | test/eval coverage 100%; retrieval/memory 경로 100%; 배포/컨테이너 경로 71% | 큰 구조적 공백은 표면상 작지만, 대표 레포별 위험 신호를 확인해야 함 | [milvus-io/milvus](https://github.com/milvus-io/milvus) | [읽기](../source-insights/by-category/data-vector-platform/README.md) |
| [스펙 드리븐/요구사항](../source-insights/by-category/spec-driven/README.md) | 5 | agent-runtime 60%, spec-artifacts 60%가 주요 강점 | 트렌드 연결률 0%라 현재성 검증 필요; security/policy 경로 20%; CI 경로 40% | [https-deeplearning-ai/sc-spec-driven-development-files](https://github.com/https-deeplearning-ai/sc-spec-driven-development-files) | [읽기](../source-insights/by-category/spec-driven/README.md) |


## 주제별 상세 해석 펼쳐보기

<details>
<summary><strong>레포별 딥다이브</strong> · 개별 레포를 선택하거나 제외할 판단 근거를 뽑습니다.</summary>
...
<details>
<summary><strong>비교/유사도 지도</strong> · 후보 프로젝트를 비교하고 선택 기준을 세웁니다.</summary>
...
<details>
<summary><strong>소스 코드 딥다이브</strong> · 레포별로 바로 확인할 코드 근거와 구현 차이를 얻습니다.</summary>
...
<details>
<summary><strong>글로벌 트렌딩 오픈소스</strong> · 전세계 트렌드 기준의 후보군과 비교 대상을 뽑습니다.</summary>
...
<details>
<summary><strong>한국 트렌딩 오픈소스</strong> · 국내 맥락에서 우선 볼 프로젝트와 차별점을 뽑습니다.</summary>
...
<details>
<summary><strong>LLM 위키/RAG/지식베이스</strong> · LLM 지식베이스와 코드 위키를 설계할 때 필요한 파이프라인 차이를 비교합니다.</summary>
...
<details>
<summary><strong>에이전트 하네스/MCP/오케스트레이션</strong> · 에이전트 런타임과 도구 실행 기반 설계 기준을 얻습니다.</summary>
...
<details>
<summary><strong>클론 구조/인벤토리</strong> · 분석 근거가 되는 원본 소스 트리를 찾습니다.</summary>
...
<details>
<summary><strong>코딩 에이전트/IDE</strong> · 코딩 에이전트 제품 구조와 구현 후보를 비교합니다.</summary>
...
<details>
<summary><strong>스펙 드리븐/요구사항</strong> · 스펙 드리븐 개발 체계를 만들 때 필요한 산출물과 연결 규칙을 뽑습니다.</summary>
...
<details>
<summary><strong>먼저 읽기</strong> · 처음 10분 안에 읽을 순서와 핵심 위치를 결정합니다.</summary>
...
<details>
<summary><strong>인접 AI 인프라</strong> · 에이전트 외부 의존 스택과 운영 준비도를 판단합니다.</summary>
...
<details>
<summary><strong>카테고리별 근거</strong> · 분석의 근거가 어디에서 왔는지 추적합니다.</summary>
...
<details>
<summary><strong>발표/컨퍼런스</strong> · 논문/코드만으로 보이지 않는 산업 채택 방향을 보완합니다.</summary>
...
<details>
<summary><strong>연구 근거</strong> · 주장과 설계 판단의 근거 수준을 보강합니다.</summary>
...
<details>
<summary><strong>소스 카탈로그/인벤토리</strong> · 분석 대상과 근거 목록의 누락 여부를 확인합니다.</summary>
...
<details>
<summary><strong>AI 활용 트렌드</strong> · 실제 제품/조직 적용 관점의 우선순위를 뽑습니다.</summary>
...
<details>
<summary><strong>전체 소스 스캔/코드 검색</strong> · 전체 소스 스캔 시스템을 설계할 때 필요한 탐색 파이프라인을 뽑습니다.</summary>
...
<details>
<summary><strong>에이전트 하네스/MCP</strong> · test/eval coverage 90%; MCP/tool 경로 76%; retrieval/memory 경로 84%</summary>
...
<details>
<summary><strong>일반 AI 오픈소스</strong> · 트렌드 연결률 98%로 현재성 강함; test/eval coverage 76%</summary>
...
<details>
<summary><strong>LLM 위키/RAG/지식베이스</strong> · test/eval coverage 86%; retrieval/memory 경로 83%; CLI 사용면이 강함</summary>
...
<details>
<summary><strong>AI 인프라/서빙</strong> · 트렌드 연결률 92%로 현재성 강함; test/eval coverage 96%; retrieval/memory 경로 95%</summary>
...
<details>
<summary><strong>개발 생산성/DevTools</strong> · 트렌드 연결률 98%로 현재성 강함; test/eval coverage 82%; retrieval/memory 경로 67%</summary>
...
<details>
<summary><strong>평가/관측/품질</strong> · test/eval coverage 100%; retrieval/memory 경로 74%</summary>
...
<details>
<summary><strong>보안/거버넌스/안전</strong> · 트렌드 연결률 90%로 현재성 강함; test/eval coverage 90%</summary>
...
<details>
<summary><strong>코딩 에이전트/IDE</strong> · 트렌드 연결률 100%로 현재성 강함; test/eval coverage 100%; MCP/tool 경로 67%</summary>
...
<details>
<summary><strong>데이터/벡터 플랫폼</strong> · test/eval coverage 100%; retrieval/memory 경로 100%; 배포/컨테이너 경로 71%</summary>
...
<details>
<summary><strong>스펙 드리븐/요구사항</strong> · agent-runtime 60%, spec-artifacts 60%가 주요 강점</summary>
