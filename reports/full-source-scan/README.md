...
- 포함 범위: 1 reports이며, 주요 유형은 source-scan-report (1)입니다.
- 탐색 방식: 아래 Navigation에서 상위 인덱스로 이동하거나, Related Topic Pages에서 같은 보고서를 주제 기준으로 다시 볼 수 있습니다.

## 총평

이 README는 원본 보고서를 옮기지 않고 폴더 단위로 읽는 입구입니다. 먼저 Recommended Reading Path로 핵심 보고서를 훑고, 필요하면 All Reports in This Folder에서 개별 조사로 내려가는 흐름이 가장 안정적입니다. 관련 주제 페이지 1개와 연결되어 있어 폴더 기준과 주제 기준을 오가며 볼 수 있습니다.
...
| Field | Value |
| --- | --- |
| Folder | `reports/full-source-scan` |
| Role | Source discovery and code retrieval mechanics. |
| Reports | 1 |
| Main report types | source-scan-report (1) |

## Related Topic Pages

| Topic | Reports in this folder |
| --- | ---: |
| [Full Source Scan and Code Retrieval](../by-topic/full-source-scan/README.md) | 1 |
