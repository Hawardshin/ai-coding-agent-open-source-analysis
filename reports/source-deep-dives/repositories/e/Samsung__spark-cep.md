...
- 조사 단위: `sources/Samsung__spark-cep` 로컬 클론을 실제 파일 트리 기준으로 분석한 레포별 딥다이브입니다.
- 포함 범위: 44 files, 23 directories, depth score 37, key references 5개입니다.
...
| 성숙도 | 초기 |
| 근거 수준 | 소스+보고서 |
| 소스 | [sources/Samsung__spark-cep](../../../../sources/Samsung__spark-cep) |
| 기존 보고서 | [reports/korea-trending/repositories/Samsung__spark-cep.md](../../../korea-trending/repositories/Samsung__spark-cep.md) |
...
| 관측 최대 깊이 | 10 |
| 상위 디렉터리 | project, src |
| 상위 확장자 | .scala: 29, .json: 4, (none): 3, .java: 2, .properties: 2, .xml: 2, .md: 1, .sbt: 1 |
...
| 표면 | Hit 수 | 대표 경로 |
| --- | ---: | --- |
| 테스트/평가 | 5 | [src/test/scala/org/apache/spark/sql/streaming/test/JoinTestSuite.scala](../../../../sources/Samsung__spark-cep/src/test/scala/org/apache/spark/sql/streaming/test/JoinTestSuite.scala)<br>[src/test/scala/org/apache/spark/sql/streaming/test/SimpleJsonFileInputDStream.scala](../../../../sources/Samsung__spark-cep/src/test/scala/org/apache/spark/sql/streaming/test/SimpleJsonFileInputDStream.scala)<br>[src/test/resources/registration.json](../../../../sources/Samsung__spark-cep/src/test/resources/registration.json)<br>[src/test/resources/student.json](../../../../sources/Samsung__spark-cep/src/test/resources/student.json)<br>[src/test/resources/teacher.json](../../../../sources/Samsung__spark-cep/src/test/resources/teacher.json) |
...
1. 핵심 참조에서 시작: `README.md`, `src/test/scala/org/apache/spark/sql/streaming/test/JoinTestSuite.scala`, `src/test/scala/org/apache/spark/sql/streaming/test/SimpleJsonFileInputDStream.scala`.
2. test/eval 파일로 동작 검증: `src/test/scala/org/apache/spark/sql/streaming/test/JoinTestSuite.scala`, `src/test/scala/org/apache/spark/sql/streaming/test/SimpleJsonFileInputDStream.scala`, `src/test/resources/registration.json`.

## 기존 레포 인사이트

일반 AI 오픈소스 관점에서 Spark CEP is an extension of Spark Streaming to support SQL based query processing. 핵심 구조 신호는 Scala, README.md, LICENSE, docs이며, 소스+보고서 근거 수준으로 초기 후보로 읽는 것이 좋습니다.
