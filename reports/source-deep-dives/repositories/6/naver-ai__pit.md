...
- 조사 단위: `sources/naver-ai__pit` 로컬 클론을 실제 파일 트리 기준으로 분석한 레포별 딥다이브입니다.
- 포함 범위: 6 files, 0 directories, depth score 27, key references 2개입니다.
...
| 성숙도 | 초기 |
| 근거 수준 | 소스+보고서 |
| 소스 | [sources/naver-ai__pit](../../../../sources/naver-ai__pit) |
| 기존 보고서 | [reports/korea-trending/repositories/naver-ai__pit.md](../../../korea-trending/repositories/naver-ai__pit.md) |
...
| 관측 최대 깊이 | 1 |
| 상위 디렉터리 | 없음 |
| 상위 확장자 | (none): 2, .md: 1, .png: 1, .py: 1, .txt: 1 |
