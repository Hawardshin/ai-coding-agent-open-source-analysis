...
- 조사 단위: `sources/naver__nam-sdk-ios` 로컬 클론을 실제 파일 트리 기준으로 분석한 레포별 딥다이브입니다.
- 포함 범위: 6,412 files, 2,499 directories, depth score 51, key references 5개입니다.
- 탐색 방식: 읽기 계획을 먼저 보고, 근거 bucket과 핵심 소스 참조의 파일 링크를 따라가면 됩니다.

## 총평

개발 생산성/DevTools 관점에서 eval/test harness 구조로 읽힌다. 핵심 소스 근거는 docs=README.md, Swift/Cocoapods/README.md, docs/rewarded/guide.md이고, 의존성 단서는 의존성 단서 약함, 검증/운영 단서는 test/eval 경로가 보임이다. 이 판단은 README 메타데이터가 아니라 로컬 소스의 5개 파일 경로를 직접 스캔해야 확인된다. 기존 레포 평가 관점은 아키텍처 비교 지점이며, 이 문서는 README/메타데이터가 아니라 실제 소스 경로를 기준으로 후속 확인 지점을 분리합니다.
...
| 성숙도 | 초기 |
| 근거 수준 | 소스+보고서 |
| 소스 | [sources/naver__nam-sdk-ios](../../../../sources/naver__nam-sdk-ios) |
| 기존 보고서 | [reports/korea-trending/repositories/naver__nam-sdk-ios.md](../../../korea-trending/repositories/naver__nam-sdk-ios.md) |
...
| 파일 / 디렉터리 | 6412 / 2499 |
| 관측 최대 깊이 | 10 |
| 상위 디렉터리 | docs, MediationSDK, NAMSDK, Swift |
| 상위 확장자 | (none): 1566, .h: 1360, .swiftinterface: 804, .plist: 777, .json: 502, .swiftdoc: 402, .xcprivacy: 294, .modulemap: 272, .png: 114, .swift: 102, .js: 60, .car: 40 |
...
| 표면 | Hit 수 | 대표 경로 |
| --- | ---: | --- |
| 테스트/평가 | 1 | [NAMSDK/SPM/Tests/NAMSDKTests.swift](../../../../sources/naver__nam-sdk-ios/NAMSDK/SPM/Tests/NAMSDKTests.swift) |
...
1. 핵심 참조에서 시작: `README.md`, `Swift/Cocoapods/README.md`, `docs/rewarded/guide.md`.
2. test/eval 파일로 동작 검증: `NAMSDK/SPM/Tests/NAMSDKTests.swift`.

## 기존 레포 인사이트

개발 생산성/DevTools 관점에서 설명 메타데이터가 짧습니다. 핵심 구조 신호는 C++, README.md, docs, spec-artifacts이며, 소스+보고서 근거 수준으로 초기 후보로 읽는 것이 좋습니다.
