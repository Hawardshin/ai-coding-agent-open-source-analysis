...
- 조사 단위: `sources/ajgarciaj__NaViL` 로컬 클론을 실제 파일 트리 기준으로 분석한 레포별 딥다이브입니다.
- 포함 범위: 4 files, 2 directories, depth score 13, key references 0개입니다.
...
| 성숙도 | 초기 |
| 근거 수준 | 소스+보고서 |
| 소스 | [sources/ajgarciaj__NaViL](../../../../sources/ajgarciaj__NaViL) |
| 기존 보고서 | [reports/korea-trending/repositories/ajgarciaj__NaViL.md](../../../korea-trending/repositories/ajgarciaj__NaViL.md) |
...
| 파일 / 디렉터리 | 4 / 2 |
| 관측 최대 깊이 | 2 |
| 상위 디렉터리 | outstudy, soothful |
| 상위 확장자 | .zip: 2, .md: 1, (none): 1 |
...
에이전트 하네스/MCP 관점에서 🌐 Rethink Multimodal Large Language Models design and scaling under data constraints with NaViL, enhancing efficiency a. 핵심 구조 신호는 README.md, docs이며, 소스+보고서 근거 수준으로 초기 후보로 읽는 것이 좋습니다.
