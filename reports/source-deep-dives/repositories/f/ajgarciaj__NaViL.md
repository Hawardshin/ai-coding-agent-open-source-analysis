# ajgarciaj/NaViL Source Deep Dive
...
- 조사 단위: `sources/ajgarciaj__NaViL` 로컬 클론을 실제 파일 트리 기준으로 분석한 레포별 deep dive입니다.
- 포함 범위: 4 files, 2 directories, depth score 19, key references 0개입니다.
...
| Source | [sources/ajgarciaj__NaViL](../../../../sources/ajgarciaj__NaViL) |
| Existing report | [reports/korea-trending/repositories/ajgarciaj__NaViL.md](../../../korea-trending/repositories/ajgarciaj__NaViL.md) |
...
| Top directories | outstudy, soothful |
| Top extensions | .zip: 2, .md: 1, (none): 1 |
...
| --- | --- | ---: |
| outstudy | top-level component | 1 |
| soothful | top-level component | 1 |
...
| docs | 1 | [README.md](../../../../sources/ajgarciaj__NaViL/README.md) |
...
에이전트 하네스/MCP 관점에서 🌐 Rethink Multimodal Large Language Models design and scaling under data constraints with NaViL, enhancing efficiency a. 핵심 구조 신호는 README.md, docs이며, source+report 근거 수준으로 emerging 후보로 읽는 것이 좋습니다.
