...
- 조사 단위: `sources/dream8837z__hwp-hwpx-proposal-mcp` 로컬 클론을 실제 파일 트리 기준으로 분석한 레포별 deep dive입니다.
...
| Field | Value |
| --- | --- |
| Repository | dream8837z/hwp-hwpx-proposal-mcp |
...
| Source | [sources/dream8837z__hwp-hwpx-proposal-mcp](../../../../sources/dream8837z__hwp-hwpx-proposal-mcp) |
| Existing report | [reports/korea-trending/repositories/dream8837z__hwp-hwpx-proposal-mcp.md](../../../korea-trending/repositories/dream8837z__hwp-hwpx-proposal-mcp.md) |
...
| docs | 1 | [README.md](../../../../sources/dream8837z__hwp-hwpx-proposal-mcp/README.md) |
...
에이전트 하네스/MCP 관점에서 An AI agent specialized in drafting Korean proposals .hwp / .hwpx — reads, writes, and edits Hancom Office files while s. 핵심 구조 신호는 README.md, docs이며, source+report 근거 수준으로 emerging 후보로 읽는 것이 좋습니다.
