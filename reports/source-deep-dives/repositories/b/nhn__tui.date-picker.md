...
- 조사 단위: `sources/nhn__tui.date-picker` 로컬 클론을 실제 파일 트리 기준으로 분석한 레포별 딥다이브입니다.
- 포함 범위: 74 files, 24 directories, depth score 74, key references 11개입니다.
...
| 성숙도 | 안정 |
| 근거 수준 | 소스+보고서 |
| 소스 | [sources/nhn__tui.date-picker](../../../../sources/nhn__tui.date-picker) |
| 기존 보고서 | [reports/korea-trending/repositories/nhn__tui.date-picker.md](../../../korea-trending/repositories/nhn__tui.date-picker.md) |
...
| 상위 확장자 | .js: 39, .md: 11, .html: 9, .json: 4, (none): 3, .css: 2, .png: 2, .ts: 2, .yml: 2 |
...
| 표면 | Hit 수 | 대표 경로 |
| --- | ---: | --- |
| 테스트/평가 | 12 | [test/dateTimeFormatter.spec.js](../../../../sources/nhn__tui.date-picker/test/dateTimeFormatter.spec.js)<br>[test/dateUtil.spec.js](../../../../sources/nhn__tui.date-picker/test/dateUtil.spec.js)<br>[test/types/type-tests.ts](../../../../sources/nhn__tui.date-picker/test/types/type-tests.ts)<br>[test/rangeModel/range.spec.js](../../../../sources/nhn__tui.date-picker/test/rangeModel/range.spec.js)<br>[test/rangeModel/rangeModel.spec.js](../../../../sources/nhn__tui.date-picker/test/rangeModel/rangeModel.spec.js)<br>[test/dateRangePicker/dateRangePicker.spec.js](../../../../sources/nhn__tui.date-picker/test/dateRangePicker/dateRangePicker.spec.js) |
| CI workflow | 1 | [.github/workflows/test_on_pull_request.yml](../../../../sources/nhn__tui.date-picker/.github/workflows/test_on_pull_request.yml) |
| 컨테이너/배포 | 0 | 명확하지 않음 |
| 보안/정책 | 0 | 명확하지 않음 |
| 에이전트 지시문 | 0 | 명확하지 않음 |
...
2. retrieval/memory/indexing 확인: `index.d.ts`, `src/template/datepicker/index.js`, `src/js/index.js`.
3. test/eval 파일로 동작 검증: `test/dateTimeFormatter.spec.js`, `test/dateUtil.spec.js`, `test/types/type-tests.ts`.

## 기존 레포 인사이트

일반 AI 오픈소스 관점에서 Component that selects specific date.. 핵심 구조 신호는 JavaScript, package.json, README.md, LICENSE, tests, ci이며, 소스+보고서 근거 수준으로 안정 후보로 읽는 것이 좋습니다.
