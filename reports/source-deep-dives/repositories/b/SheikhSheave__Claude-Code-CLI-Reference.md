...
- 조사 단위: `sources/SheikhSheave__Claude-Code-CLI-Reference` 로컬 클론을 실제 파일 트리 기준으로 분석한 레포별 deep dive입니다.
- 포함 범위: 2 files, 0 directories, depth score 16, key references 0개입니다.
...
| Field | Value |
| --- | --- |
| Repository | SheikhSheave/Claude-Code-CLI-Reference |
...
| Source | [sources/SheikhSheave__Claude-Code-CLI-Reference](../../../../sources/SheikhSheave__Claude-Code-CLI-Reference) |
| Existing report | [reports/global-trending/repositories/SheikhSheave__Claude-Code-CLI-Reference.md](../../../global-trending/repositories/SheikhSheave__Claude-Code-CLI-Reference.md) |
...
| Field | Value |
| --- | --- |
| Files / directories | 2 / 0 |
| Max observed depth | 1 |
| Top directories | none |
| Top extensions | .md: 1, .txt: 1 |
...
| docs | 1 | [README.md](../../../../sources/SheikhSheave__Claude-Code-CLI-Reference/README.md) |
...
에이전트 하네스/MCP 관점에서 claude code cli install codex github anthropic agentic coding system terminal assistant codebase git workflows multi fil. 핵심 구조 신호는 README.md, docs이며, source+report 근거 수준으로 emerging 후보로 읽는 것이 좋습니다.
