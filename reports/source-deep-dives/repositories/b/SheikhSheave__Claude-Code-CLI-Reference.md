# SheikhSheave/Claude-Code-CLI-Reference 소스 딥다이브
...
- 조사 단위: `sources/SheikhSheave__Claude-Code-CLI-Reference` 로컬 클론을 실제 파일 트리 기준으로 분석한 레포별 딥다이브입니다.
- 포함 범위: 2 files, 0 directories, depth score 10, key references 0개입니다.
...
| 항목 | 값 |
| --- | --- |
| 레포 | SheikhSheave/Claude-Code-CLI-Reference |
...
| 성숙도 | 초기 |
| 근거 수준 | 소스+보고서 |
| 소스 | [sources/SheikhSheave__Claude-Code-CLI-Reference](../../../../sources/SheikhSheave__Claude-Code-CLI-Reference) |
| 기존 보고서 | [reports/global-trending/repositories/SheikhSheave__Claude-Code-CLI-Reference.md](../../../global-trending/repositories/SheikhSheave__Claude-Code-CLI-Reference.md) |
...
에이전트 하네스/MCP 관점에서 claude code cli install codex github anthropic agentic coding system terminal assistant codebase git workflows multi fil. 핵심 구조 신호는 README.md, docs이며, 소스+보고서 근거 수준으로 초기 후보로 읽는 것이 좋습니다.
