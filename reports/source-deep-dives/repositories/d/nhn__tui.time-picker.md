# nhn/tui.time-picker Source Deep Dive
...
- 조사 단위: `sources/nhn__tui.time-picker` 로컬 클론을 실제 파일 트리 기준으로 분석한 레포별 deep dive입니다.
- 포함 범위: 46 files, 14 directories, depth score 76, key references 10개입니다.
...
| Field | Value |
| --- | --- |
| Repository | nhn/tui.time-picker |
...
| Source | [sources/nhn__tui.time-picker](../../../../sources/nhn__tui.time-picker) |
| Existing report | [reports/korea-trending/repositories/nhn__tui.time-picker.md](../../../korea-trending/repositories/nhn__tui.time-picker.md) |
...
| Field | Value |
| --- | --- |
| Files / directories | 46 / 14 |
| Max observed depth | 4 |
| Top directories | .github, docs, examples, src, test |
| Top extensions | .js: 18, .md: 10, .html: 5, .json: 4, (none): 3, .css: 2, .png: 2, .yml: 2 |
...
| --- | ---: | --- |
| Tests / evals | 5 | [test/util.spec.js](../../../../sources/nhn__tui.time-picker/test/util.spec.js)<br>[test/timepicker/selectbox.spec.js](../../../../sources/nhn__tui.time-picker/test/timepicker/selectbox.spec.js)<br>[test/timepicker/spinbox.spec.js](../../../../sources/nhn__tui.time-picker/test/timepicker/spinbox.spec.js)<br>[test/timepicker/timepicker.spec.js](../../../../sources/nhn__tui.time-picker/test/timepicker/timepicker.spec.js)<br>[.github/workflows/test_on_pull_request.yml](../../../../sources/nhn__tui.time-picker/.github/workflows/test_on_pull_request.yml) |
| CI workflows | 1 | [.github/workflows/test_on_pull_request.yml](../../../../sources/nhn__tui.time-picker/.github/workflows/test_on_pull_request.yml) |
...
2. Inspect retrieval/memory/indexing through: `src/template/index.js`, `src/js/index.js`, `src/js/timepicker/index.js`.
3. Verify behavior through test/eval files: `test/util.spec.js`, `test/timepicker/selectbox.spec.js`, `test/timepicker/spinbox.spec.js`.

## Existing Repository Insight

일반 AI 오픈소스 관점에서 Component that selects specific time.. 핵심 구조 신호는 JavaScript, package.json, README.md, LICENSE, tests, ci이며, source+report 근거 수준으로 solid 후보로 읽는 것이 좋습니다.
