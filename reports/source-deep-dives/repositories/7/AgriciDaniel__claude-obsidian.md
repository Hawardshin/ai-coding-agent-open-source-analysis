# AgriciDaniel/claude-obsidian 소스 딥다이브
...
- 조사 단위: `sources/AgriciDaniel__claude-obsidian` 로컬 클론을 실제 파일 트리 기준으로 분석한 레포별 딥다이브입니다.
- 포함 범위: 211 files, 64 directories, depth score 109, key references 12개입니다.
- 탐색 방식: 읽기 계획을 먼저 보고, 근거 bucket과 핵심 소스 참조의 파일 링크를 따라가면 됩니다.

## 총평

LLM 위키/RAG/지식베이스 관점에서 cli-first, agent/tool runtime, retrieval/vector path 구조로 읽힌다. 핵심 소스 근거는 retrieval=WIKI.md, wiki/getting-started.md, wiki/hot.md이고, 의존성 단서는 의존성 단서 약함, 검증/운영 단서는 test/eval 경로가 보임, CI 워크플로가 보임, 에이전트 지시문 파일이 보임이다. 이 판단은 README 메타데이터가 아니라 로컬 소스의 12개 파일 경로를 직접 스캔해야 확인된다. 기존 레포 평가 관점은 지식/RAG 패턴 참고이며, 이 문서는 README/메타데이터가 아니라 실제 소스 경로를 기준으로 후속 확인 지점을 분리합니다.
...
| 항목 | 값 |
| --- | --- |
| 레포 | AgriciDaniel/claude-obsidian |
...
| 성숙도 | 고신호 |
| 근거 수준 | 소스+보고서 |
| 소스 | [sources/AgriciDaniel__claude-obsidian](../../../../sources/AgriciDaniel__claude-obsidian) |
| 기존 보고서 | [reports/llm-wiki/repositories/AgriciDaniel__claude-obsidian.md](../../../llm-wiki/repositories/AgriciDaniel__claude-obsidian.md) |
...
| 파일 / 디렉터리 | 211 / 64 |
| 관측 최대 깊이 | 5 |
| 상위 디렉터리 | _templates, .claude-plugin, .cursor, .github, .obsidian, .raw, .vault-meta, .windsurf, agents, assets, bin, commands, docs, hooks, scripts, skills, tests, wiki |
| 상위 확장자 | .md: 120, .json: 17, .py: 15, .sh: 11, .png: 8, .css: 7, .svg: 6, (none): 6, .canvas: 5, .gif: 5, .js: 3, .txt: 2 |
...
| CI workflow | 1 | [.github/workflows/test.yml](../../../../sources/AgriciDaniel__claude-obsidian/.github/workflows/test.yml) |
| 컨테이너/배포 | 0 | 명확하지 않음 |
| 보안/정책 | 5 | [SECURITY.md](../../../../sources/AgriciDaniel__claude-obsidian/SECURITY.md)<br>[wiki/meta/full-audit-and-system-setup-session.md](../../../../sources/AgriciDaniel__claude-obsidian/wiki/meta/full-audit-and-system-setup-session.md)<br>[docs/audits/v1.7.0-audit-2026-05-17.md](../../../../sources/AgriciDaniel__claude-obsidian/docs/audits/v1.7.0-audit-2026-05-17.md)<br>[docs/audits/v1.8.0-pre-push-audit-2026-05-18.md](../../../../sources/AgriciDaniel__claude-obsidian/docs/audits/v1.8.0-pre-push-audit-2026-05-18.md)<br>[docs/audits/v1.9.0-pre-public-promotion-audit-2026-05-18.md](../../../../sources/AgriciDaniel__claude-obsidian/docs/audits/v1.9.0-pre-public-promotion-audit-2026-05-18.md) |
| 에이전트 지시문 | 5 | [AGENTS.md](../../../../sources/AgriciDaniel__claude-obsidian/AGENTS.md)<br>[CLAUDE.md](../../../../sources/AgriciDaniel__claude-obsidian/CLAUDE.md)<br>[GEMINI.md](../../../../sources/AgriciDaniel__claude-obsidian/GEMINI.md)<br>[.github/copilot-instructions.md](../../../../sources/AgriciDaniel__claude-obsidian/.github/copilot-instructions.md)<br>[.cursor/rules/claude-obsidian.mdc](../../../../sources/AgriciDaniel__claude-obsidian/.cursor/rules/claude-obsidian.mdc) |
...
1. 핵심 참조에서 시작: `WIKI.md`, `wiki/getting-started.md`, `wiki/hot.md`.
2. entrypoint를 따라 실행 흐름 확인: `bin/setup-dragonscale.sh`, `bin/setup-mode.sh`, `bin/setup-multi-agent.sh`.
3. agent/tool runtime 매핑: `AGENTS.md`, `wiki/meta/workflow-loop.gif`, `skills/wiki-retrieve/SKILL.md`.
4. retrieval/memory/indexing 확인: `WIKI.md`, `wiki/getting-started.md`, `wiki/hot.md`.
5. test/eval 파일로 동작 검증: `wiki/meta/dragonscale-6-test-flow.png`, `wiki/meta/dragonscale-6-test-flow.svg`, `wiki/meta/retrieval-benchmark-v1.7.md`.

## 기존 레포 인사이트

LLM 위키/RAG/지식베이스 관점에서 Self organizing AI second brain for Obsidian + Claude Code. Drop any source and Claude reads, links, and files it into o. 핵심 구조 신호는 Python, Makefile, README.md, AGENTS.md, CLAUDE.md, LICENSE이며, 소스+보고서 근거 수준으로 고신호 후보로 읽는 것이 좋습니다.
