...
- 조사 단위: `sources/nhn__tui.tree` 로컬 클론을 실제 파일 트리 기준으로 분석한 레포별 딥다이브입니다.
- 포함 범위: 70 files, 16 directories, depth score 71, key references 10개입니다.
...
| 성숙도 | 안정 |
| 근거 수준 | 소스+보고서 |
| 소스 | [sources/nhn__tui.tree](../../../../sources/nhn__tui.tree) |
| 기존 보고서 | [reports/korea-trending/repositories/nhn__tui.tree.md](../../../korea-trending/repositories/nhn__tui.tree.md) |
...
| 상위 확장자 | .js: 32, .md: 12, .html: 10, .json: 5, .css: 4, (none): 3, .yml: 2, .gif: 1, .png: 1 |
...
| 표면 | Hit 수 | 대표 경로 |
| --- | ---: | --- |
| 테스트/평가 | 14 | [test/.eslintrc.js](../../../../sources/nhn__tui.tree/test/.eslintrc.js)<br>[test/setup-globals.js](../../../../sources/nhn__tui.tree/test/setup-globals.js)<br>[test/tree.spec.js](../../../../sources/nhn__tui.tree/test/tree.spec.js)<br>[test/treeModel.spec.js](../../../../sources/nhn__tui.tree/test/treeModel.spec.js)<br>[test/treeNode.spec.js](../../../../sources/nhn__tui.tree/test/treeNode.spec.js)<br>[test/util.spec.js](../../../../sources/nhn__tui.tree/test/util.spec.js) |
| CI workflow | 1 | [.github/workflows/test_on_pull_request.yml](../../../../sources/nhn__tui.tree/.github/workflows/test_on_pull_request.yml) |
| 컨테이너/배포 | 0 | 명확하지 않음 |
| 보안/정책 | 0 | 명확하지 않음 |
| 에이전트 지시문 | 0 | 명확하지 않음 |
...
1. 핵심 참조에서 시작: `package.json`, `README.md`, `docs/ajax-feature.md`.
2. retrieval/memory/indexing 확인: `src/js/index.js`.
3. test/eval 파일로 동작 검증: `test/.eslintrc.js`, `test/setup-globals.js`, `test/tree.spec.js`.

## 기존 레포 인사이트

일반 AI 오픈소스 관점에서 Component that displays data hierarchically.. 핵심 구조 신호는 JavaScript, package.json, README.md, LICENSE, tests, ci이며, 소스+보고서 근거 수준으로 안정 후보로 읽는 것이 좋습니다.
