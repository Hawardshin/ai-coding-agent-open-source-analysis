...
- 조사 단위: `sources/daangn__lynx-console` 로컬 클론을 실제 파일 트리 기준으로 분석한 레포별 딥다이브입니다.
- 포함 범위: 179 files, 44 directories, depth score 90, key references 12개입니다.
...
| 성숙도 | 초기 |
| 근거 수준 | 소스+보고서 |
| 소스 | [sources/daangn__lynx-console](../../../../sources/daangn__lynx-console) |
| 기존 보고서 | [reports/korea-trending/repositories/daangn__lynx-console.md](../../../korea-trending/repositories/daangn__lynx-console.md) |
...
| 파일 / 디렉터리 | 179 / 44 |
| 관측 최대 깊이 | 7 |
| 상위 디렉터리 | .agents, .changeset, .github, .yarn, example, package |
| 상위 확장자 | .md: 97, .ts: 28, .tsx: 15, .json: 11, .css: 8, (none): 6, .cjs: 5, .mjs: 4, .yml: 4, .lock: 1 |
| 소스 패턴 | api/server, agent/tool runtime, retrieval/vector path, eval/test harness, ui/extension surface |
...
| 표면 | Hit 수 | 대표 경로 |
| --- | ---: | --- |
| 테스트/평가 | 15 | [.agents/skills/lynx-trace-record/LICENSE](../../../../sources/daangn__lynx-console/.agents/skills/lynx-trace-record/LICENSE)<br>[.agents/skills/lynx-trace-record/SKILL.md](../../../../sources/daangn__lynx-console/.agents/skills/lynx-trace-record/SKILL.md)<br>[.agents/skills/lynx-trace-record/scripts/shared.bundle.cjs](../../../../sources/daangn__lynx-console/.agents/skills/lynx-trace-record/scripts/shared.bundle.cjs)<br>[.agents/skills/lynx-trace-record/scripts/trace_record.bundle.cjs](../../../../sources/daangn__lynx-console/.agents/skills/lynx-trace-record/scripts/trace_record.bundle.cjs)<br>[.agents/skills/lynx-trace-analysis/LICENSE](../../../../sources/daangn__lynx-console/.agents/skills/lynx-trace-analysis/LICENSE)<br>[.agents/skills/lynx-trace-analysis/SKILL.md](../../../../sources/daangn__lynx-console/.agents/skills/lynx-trace-analysis/SKILL.md) |
| CI workflow | 3 | [.github/workflows/check-changeset.yml](../../../../sources/daangn__lynx-console/.github/workflows/check-changeset.yml)<br>[.github/workflows/deploy-package.yml](../../../../sources/daangn__lynx-console/.github/workflows/deploy-package.yml)<br>[.github/workflows/lint.yml](../../../../sources/daangn__lynx-console/.github/workflows/lint.yml) |
| 컨테이너/배포 | 0 | 명확하지 않음 |
| 보안/정책 | 0 | 명확하지 않음 |
| 에이전트 지시문 | 0 | 명확하지 않음 |
...
1. 핵심 참조에서 시작: `package/src/index.tsx`, `example/src/App.css`, `example/src/App.tsx`.
2. entrypoint를 따라 실행 흐름 확인: `package/src/index.tsx`, `example/src/App.css`, `example/src/App.tsx`.
3. agent/tool runtime 매핑: `skills-lock.json`, `package/src/hooks/index.ts`, `package/src/hooks/useConsole.ts`.
4. retrieval/memory/indexing 확인: `package/src/index.tsx`, `package/src/setup/index.ts`, `package/src/hooks/index.ts`.
5. test/eval 파일로 동작 검증: `.agents/skills/lynx-trace-record/LICENSE`, `.agents/skills/lynx-trace-record/SKILL.md`, `.agents/skills/lynx-trace-record/scripts/shared.bundle.cjs`.

## 기존 레포 인사이트

일반 AI 오픈소스 관점에서 설명 메타데이터가 짧습니다. 핵심 구조 신호는 JavaScript, package.json, react, ci이며, 소스+보고서 근거 수준으로 초기 후보로 읽는 것이 좋습니다.
