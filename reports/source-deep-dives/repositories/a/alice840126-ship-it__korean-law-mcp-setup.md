...
- 조사 단위: `sources/alice840126-ship-it__korean-law-mcp-setup` 로컬 클론을 실제 파일 트리 기준으로 분석한 레포별 딥다이브입니다.
- 포함 범위: 3 files, 0 directories, depth score 12, key references 0개입니다.
...
| 항목 | 값 |
| --- | --- |
| 레포 | alice840126-ship-it/korean-law-mcp-setup |
...
| 성숙도 | 초기 |
| 근거 수준 | 소스+보고서 |
| 소스 | [sources/alice840126-ship-it__korean-law-mcp-setup](../../../../sources/alice840126-ship-it__korean-law-mcp-setup) |
| 기존 보고서 | [reports/korea-trending/repositories/alice840126-ship-it__korean-law-mcp-setup.md](../../../korea-trending/repositories/alice840126-ship-it__korean-law-mcp-setup.md) |
...
에이전트 하네스/MCP 관점에서 한국 법령 MCP Claude Code 연동 세팅. 핵심 구조 신호는 README.md, docs이며, 소스+보고서 근거 수준으로 초기 후보로 읽는 것이 좋습니다.
