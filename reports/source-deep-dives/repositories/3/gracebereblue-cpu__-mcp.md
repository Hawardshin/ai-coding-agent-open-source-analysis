...
- 조사 단위: `sources/gracebereblue-cpu__-mcp` 로컬 클론을 실제 파일 트리 기준으로 분석한 레포별 딥다이브입니다.
- 포함 범위: 0 files, 0 directories, depth score 3, key references 0개입니다.
...
| 성숙도 | 관찰 |
| 근거 수준 | 소스+보고서 |
| 소스 | [sources/gracebereblue-cpu__-mcp](../../../../sources/gracebereblue-cpu__-mcp) |
| 기존 보고서 | [reports/korea-trending/repositories/gracebereblue-cpu__-mcp.md](../../../korea-trending/repositories/gracebereblue-cpu__-mcp.md) |
...
에이전트 하네스/MCP 관점에서 공무원이 만든 법제처 MCP https //github.com/chrisryugj/korean law mcp. 핵심 구조 신호는 메타데이터만이며, 소스+보고서 근거 수준으로 관찰 후보로 읽는 것이 좋습니다.
