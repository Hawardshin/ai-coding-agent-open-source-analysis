# gracebereblue-cpu/-mcp Source Deep Dive
...
- 조사 단위: `sources/gracebereblue-cpu__-mcp` 로컬 클론을 실제 파일 트리 기준으로 분석한 레포별 deep dive입니다.
- 포함 범위: 0 files, 0 directories, depth score 9, key references 0개입니다.
...
| Field | Value |
| --- | --- |
| Repository | gracebereblue-cpu/-mcp |
...
| Source | [sources/gracebereblue-cpu__-mcp](../../../../sources/gracebereblue-cpu__-mcp) |
| Existing report | [reports/korea-trending/repositories/gracebereblue-cpu__-mcp.md](../../../korea-trending/repositories/gracebereblue-cpu__-mcp.md) |
...
에이전트 하네스/MCP 관점에서 공무원이 만든 법제처 MCP https //github.com/chrisryugj/korean law mcp. 핵심 구조 신호는 metadata-only이며, source+report 근거 수준으로 watchlist 후보로 읽는 것이 좋습니다.
