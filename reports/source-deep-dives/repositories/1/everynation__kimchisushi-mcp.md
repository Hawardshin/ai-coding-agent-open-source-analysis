# everynation/kimchisushi-mcp Source Deep Dive

Generated: 2026-06-18T15:12:44.535Z

Remote MCP server for kimchi-sushi.com — Korea-Japan bilingual community (public posts/comments for AI agents)

## 요약

- 조사 단위: `sources/everynation__kimchisushi-mcp` 로컬 클론을 실제 파일 트리 기준으로 분석한 레포별 deep dive입니다.
- 포함 범위: 1 files, 0 directories, depth score 13, key references 0개입니다.
...
| Field | Value |
| --- | --- |
| Repository | everynation/kimchisushi-mcp |
...
| Source | [sources/everynation__kimchisushi-mcp](../../../../sources/everynation__kimchisushi-mcp) |
| Existing report | [reports/korea-trending/repositories/everynation__kimchisushi-mcp.md](../../../korea-trending/repositories/everynation__kimchisushi-mcp.md) |
...
| docs | 1 | [README.md](../../../../sources/everynation__kimchisushi-mcp/README.md) |
...
에이전트 하네스/MCP 관점에서 Remote MCP server for kimchi sushi.com — Korea Japan bilingual community public posts/comments for AI agents. 핵심 구조 신호는 README.md, docs이며, source+report 근거 수준으로 emerging 후보로 읽는 것이 좋습니다.
